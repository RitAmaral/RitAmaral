...
My name is **Rita** 😁, I finished a training program called **Software Developer** 📖💻, where I built my theoretical knowledge and technical skills necessary to enter the professional job market in the field of Web and Mobile Programming.

During this program, I was exposed to various software architectures, such as the *Model-View-Controller* pattern, and have gained hands-on experience with databases like *MySQL*. Additionally, I learned client-side technologies such as *HTML*, *CSS*, and *JavaScript*, as well as server-side web platforms like *C#* and *PHP*. In the realm of mobile app development, I worked with *Kotlin* and *Swift* 📱.

This learning experience was incredible, and I am truly passionate about exploring the vast world of programming. I'm excited to continue expanding my knowledge and skills in order to contribute to innovative projects in the future.
